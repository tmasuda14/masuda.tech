...
function Contact() {
    return (
        <ul className="contact-list">
            ...
            <li><i class="far fa-envelope"></i><a className="email-cell-link" href="mailto:tmasuda14@gmail.com"> tmasuda14@gmail.com</a></li>
            <li><i class="fas fa-mobile-alt"></i><a className="email-cell-link" href="tel:15305182745"> 530-518-2745</a></li>
        </ul>
    )    
}
